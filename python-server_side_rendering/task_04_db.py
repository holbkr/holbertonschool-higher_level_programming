...
def products():
    ...
    if file == 'json':
        ...
        try:
            ...
            '''clé pour accéder aux colonnes par nom plutôt que par leur
            position.
            En gros on va pouvoir accéder au caractéristique de l'objet par le
            nom des colonnes comme dans un dictionnaire'''
